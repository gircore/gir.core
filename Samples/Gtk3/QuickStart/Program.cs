...
void OnPageSwitched(Notebook sender, Notebook.SwitchPageSignalArgs args)
{
...
// with some text.
void OnOpenButtonClick(Button sender, System.EventArgs args)
{
...
void OnCloseButtonClick(Button sender, System.EventArgs args)
{
    // Close the window
    PopupWindow!.Close();
