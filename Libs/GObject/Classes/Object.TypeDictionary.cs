...
namespace GObject
{
    ...
    {
            public static class TypeDictionary2
        {
            #region Fields
            ...
            public static Type? Get(System.Type type)
                => TypeDict.TryGetValue(type, out Type cachedGtype) ? cachedGtype : default;
            ...
            /// </summary>
            private static Object.TypeDescriptor? GetTypeDescriptor(System.Type type)
            {
