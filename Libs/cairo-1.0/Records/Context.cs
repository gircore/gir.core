...
namespace cairo
{
    public partial class Context
    {
        ...
        [DllImport ("cairo", EntryPoint = "cairo_set_source_rgba")]
        ...
        [DllImport ("cairo", EntryPoint = "cairo_show_text")]
        ...
        [DllImport ("cairo", EntryPoint = "cairo_font_extents")]
        ...
        [DllImport ("cairo", EntryPoint = "cairo_fill")]
        internal static extern void NativeFill (Native.Context.Handle cr);

        public void Fill()
            => NativeFill(Handle);
        
        [DllImport ("cairo", EntryPoint = "cairo_rectangle")]
        ...
        [DllImport ("cairo", EntryPoint = "cairo_set_font_size")]
