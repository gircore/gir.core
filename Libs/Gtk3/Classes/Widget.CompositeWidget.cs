...
namespace Gtk
{
    public partial class Widget
    {
        ...
        protected void ConnectTemplateChildToField<T>(string name, ref T field) where T : GObject.Object
        {
            ...
            field = Wrapper.WrapHandle<T>(ptr, false);
        }
        ...
        {
            if(!Wrapper.TryWrapHandle<Widget>(@object, false, out var eventSender))
                return;
            ...
            if(!Wrapper.TryWrapHandle<Widget>(connect_object, false, out var compositeWidget))
                return;
