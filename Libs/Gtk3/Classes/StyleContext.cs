...
namespace Gtk
{
    public partial class StyleContext
    {
        ...
        public void SetScreen(Gdk.Screen screen) => Native.set_screen(Handle, screen.Handle);
        ...
        public static void AddProviderForScreen(Gdk.Screen screen, CssProvider provider, uint priority)
            => Native.add_provider_for_screen(screen.Handle, provider.Handle, priority);
        ...
        /// </summary>
        public void AddProvider(CssProvider provider, uint priority) => Native.add_provider(Handle, provider.Handle, priority);
    }
}
