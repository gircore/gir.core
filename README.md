...
## How to help
Anyone who wants to help is very welcome. If you want to get into the project you can just grab some [good first issues](https://github.com/gircore/gir.core/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) or get in contact via a [discussion entry](https://github.com/gircore/gir.core/discussions).
