...
namespace Repository
{
    public class RepositoryInternal
    {
        ...
        public RepositoryInternal(ILoaderService loaderService)
        {
        ...
        public IEnumerable<ILoadedProject> Load(ResolveFileFunc fileFunc, string[] targets)
        {
            ...
            var loadedProjects = _loaderService.LoadOrdered(targets, fileFunc);
            ...
            // Resolve References
            // The NamespaceFactory creates unresolved references. We need to crawl through
