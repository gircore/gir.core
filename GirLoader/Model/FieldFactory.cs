...
namespace Gir.Model
{
    internal class FieldFactory
    {
        ...
        public Field Create(Xml.Field info, Repository repository)
        {
            ...
            return new Field(
                elementName: new ElementName(IdentifierConverter.EscapeIdentifier(info.Name)),
                symbolName: new SymbolName(CaseConverter.ToPascalCase(IdentifierConverter.EscapeIdentifier(info.Name))),
