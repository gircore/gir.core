...
namespace Gir.Model
{
    internal class SingleParameterFactory
    {
        ...
        public SingleParameter Create(Xml.Parameter parameter, NamespaceName currentNamespace)
        {
            ...
            var elementName = new ElementName(IdentifierConverter.EscapeIdentifier(parameter.Name));
            var elementManagedName = new SymbolName(IdentifierConverter.EscapeIdentifier(CaseConverter.ToCamelCase(parameter.Name)));
