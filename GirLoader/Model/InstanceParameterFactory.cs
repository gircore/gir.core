...
namespace Gir.Model
{
    internal class InstanceParameterFactory
    {
        ...
        public InstanceParameter Create(InstanceParameterInfo parameterInfo, NamespaceName namespaceName)
        {
            ...
            var elementName = new ElementName(IdentifierConverter.EscapeIdentifier(parameterInfo.Name));
            var elementManagedName = new SymbolName(IdentifierConverter.EscapeIdentifier(CaseConverter.ToCamelCase(parameterInfo.Name)));
