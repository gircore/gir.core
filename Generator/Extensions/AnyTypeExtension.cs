    ...
    internal static class AnyTypeExtension
    {
        ...
        private static string WriteNativeType(AnyType anyType, Namespace currentNamespace, bool useSafeHandle = true)
        {
            return anyType switch
            {
                ...
                { TypeReference: ArrayTypeReference { ResolvedType: Union u, TypeReference: { CTypeReference: { IsPointer: false } } } } => GetStructName(u, currentNamespace) + "[]",
                { TypeReference: ArrayTypeReference { ResolvedType: Union u, TypeReference: { CTypeReference: null } } } => GetStructName(u, currentNamespace) + "[]",
                { TypeReference: { ResolvedType: Union u, CTypeReference: { IsPointer: false } } } => GetStructName(u, currentNamespace),
                
                // References to unions which are using a pointer
                { TypeReference: ArrayTypeReference { ResolvedType: Union, TypeReference: { CTypeReference: { IsPointer: true } } } } => "IntPtr[]", //Array of SafeHandle not supported by runtime
                { TypeReference: ResolveableTypeReference { ResolvedType: Union, CTypeReference: { IsPointer: true } } } => "IntPtr",
