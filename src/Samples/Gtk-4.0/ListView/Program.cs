...
application.OnActivate += (sender, args) =>
{
    ...
    buttonShowCodeListView.OnClicked += (_, _) => ListViewSample.CodeListViewWindow.New().Show();

    var buttonShowTemplateListView = CreateButton("Show Template ListView Window");
    buttonShowTemplateListView.OnClicked += (_, _) => ListViewSample.TemplateListViewWindow.New().Show();
