...
application.OnActivate += (sender, args) =>
{
    ...
    buttonStringListGridView.OnClicked += (_, _) => GridViewSample.StringListGridViewWindow.New().Show();

    var buttonCustomObjectGridView = CreateButton("Custom Object GridView Window");
    buttonCustomObjectGridView.OnClicked += (_, _) => GridViewSample.CustomObjectGridViewWindow.New().Show();
