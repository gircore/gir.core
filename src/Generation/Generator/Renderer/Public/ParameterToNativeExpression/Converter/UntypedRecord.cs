    ...
    public void Initialize(ParameterToNativeData parameter, IEnumerable<ParameterToNativeData> _)
    {
        switch (parameter.Parameter.Direction)
        {
            ...
            case GirModel.Direction.Out:
                ...
                break;
            default:
                throw new NotImplementedException($"{parameter.Parameter.AnyTypeReferenceOrVarArgs}: untyped record parameter '{parameter.Parameter.Name}' with direction {parameter.Parameter.Direction} not yet supported");
        }
    }
