...
internal static class SubclassCode
{
    ...
    private static string RenderSubclassContent(SubclassData subclassData)
    {
        ...
        return $$"""
                  {{subclassData.TypeData.Properties.Accessibility}} unsafe partial class {{subclassData.TypeData.Properties.NameGenericArguments}} : {{subclassData.Parent}}, global::GObject.GTypeProvider
                  {
                       ...
                       /// </summary>
                       /// <remarks>
                       /// The content of this method can be generated by GirCore.Gtk-4.0
    ...
    private static string RenderAbstractSubclassContent(SubclassData subclassData)
    {
        ...
        return $$"""
                  ...
                  {
                       {{GeneratedCodeAttribute.Render()}}
                       private static readonly global::GObject.Type GType = global::GObject.Internal.SubclassRegistrar.RegisterAbstract<{{subclassData.TypeData.Properties.NameGenericArguments}}, {{subclassData.Parent}}>(&ClassInit, &InstanceInit, {{qualifiedName}});
