...
gchar** girtest_utf8_string_array_null_terminated_tester_optional_size_out_transfer_full(gchar** data, int *size);
gchar** girtest_utf8_string_array_null_terminated_tester_size_out_transfer_full(gchar** data, int *size);
gchar ** girtest_utf8_string_array_null_terminated_tester_optional_gsize_parameter_out_transfer_full(gchar** data, gsize *size);
gchar ** girtest_utf8_string_array_null_terminated_tester_gsize_parameter_out_transfer_full(gchar** data, gsize *size);
