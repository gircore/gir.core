...
public static class Module
{
    ...
    /// <summary>
    /// Initialize the <c>GdkWin32</c> module.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Calling this method is necessary to correctly initialize the bindings
    /// and should be done before using anything else in the <see cref="GdkWin32" />
    /// namespace.
    /// </para>
    /// <para>
    ...
    /// GdkWin32. If the given DllImportResolver receives the library name "GdkWin32" it has to return a pointer
    /// to the desired native GdkWin32 binary.
    /// </summary>
    /// <remarks>
